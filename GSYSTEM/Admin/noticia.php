      ...
      <div class="col-md-8">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 id="title-form" class="panel-title">Crear Noticia</h3>
          </div>
             ...
             <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtFechaInicio" id="txtFechaInicio" placeholder="Ejm:">
                </div>
                <div class="form-group">
                  <label>Fecha Final</label>
                  <input type="text" class="form-control" name="txtFechaFin" id="txtFechaFin" placeholder="Ejm:">
                </div>
              </div>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-heading">
          <h3 id="title-list" class="panel-title">Listado de noticias</h3>
        </div>
