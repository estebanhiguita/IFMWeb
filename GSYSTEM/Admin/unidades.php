                    ...
                    <div class="panel-body">
                        <form id="frmUnidades">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="imagen[]" name="urlUnidad2">
                            </div>
                            <div class="form-group">
                                <label for="urlUnidad">Imagen</label>
                                <input type="file" class="form-control" id="imagen[]" name="urlUnidad">
                            </div>

                            <div class="form-group">
                                <label for="urlVideo">Descripción</label>
                                <input type="text" class="form-control" id="inputlg" name="descripcion" minlength="1" maxlength="80" required>
                            </div>
